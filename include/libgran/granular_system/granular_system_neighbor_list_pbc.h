...
#else
#define binary_system_implementation rotational_binary_system_neighbors_pbc_omp
#include <libtimestep/rotational_system/rotational_binary_system_neighbors_pbc_omp.h>
